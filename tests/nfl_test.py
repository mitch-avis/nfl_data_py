...
class test_pbp(unittest.TestCase):
    ...
    def test_uses_cache_when_cache_is_true(self):
        ...
        self.assertRaises(ValueError, nfl.import_pbp_data, [2020], cache=True, alt_path=cache)
...
class test_seasonal(unittest.TestCase):
    def test_is_df_with_data(self):
...
class test_pbp_cols(unittest.TestCase):
...
class test_weekly_cols(unittest.TestCase):
    def test_is_list_with_data(self):
...
class test_seasonal_rosters(unittest.TestCase):
...
class test_weekly_rosters(unittest.TestCase):
...
class test_team_desc(unittest.TestCase):
    def test_is_df_with_data(self):
...
class test_schedules(unittest.TestCase):
    def test_is_df_with_data(self):
...
class test_win_totals(unittest.TestCase):
    def test_is_df_with_data(self):
...
class test_officials(unittest.TestCase):
    def test_is_df_with_data(self):
...
class test_draft_picks(unittest.TestCase):
    def test_is_df_with_data(self):
...
class test_draft_values(unittest.TestCase):
    def test_is_df_with_data(self):
...
class test_ids(unittest.TestCase):
    def test_is_df_with_data(self):
        s = nfl.import_ids()
        self.assertEqual(True, isinstance(s, pd.DataFrame))
        self.assertTrue(len(s) > 0)
...
class test_depth_charts(unittest.TestCase):
    def test_is_df_with_data(self):
...
class test_injuries(unittest.TestCase):
    def test_is_df_with_data(self):
...
class test_qbr(unittest.TestCase):
    def test_is_df_with_data(self):
        s = nfl.import_qbr()
        self.assertEqual(True, isinstance(s, pd.DataFrame))
        self.assertTrue(len(s) > 0)
...
class test_seasonal_pfr(unittest.TestCase):
...
class test_weekly_pfr(unittest.TestCase):
...
class test_snaps(unittest.TestCase):
    def test_is_df_with_data(self):
...
class test_ftn(unittest.TestCase):
    def test_is_df_with_data(self):
...
class test_contracts(unittest.TestCase):
